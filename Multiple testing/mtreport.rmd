...
In this research, we will try to study which genes are the most relevant in determining the concentration of a specific protein.   
...
We perform a multitest, where we obta
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.width=10, fig.height=7, results='hide'}
...
In order to select the lower bound, we choose the Benjamini-Yekutieli method beacuse is the most restrictive. 
